                ...
                <div
                    ...
                    {{
                        ($extraModalWindowAttributeBag ?? new \Illuminate\View\ComponentAttributeBag)->class([
                            'fi-modal-window pointer-events-auto relative row-start-2 flex w-full cursor-default flex-col shadow-xl ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10',
                    ...
                    @if ($heading || $header)
                        <div
                            @class([
                                ...
                                'fi-sticky sticky top-0 z-10 border-b border-gray-200 pb-6 dark:border-white/10 dark:bg-gray-900' => $stickyHeader,
                    ...
                    @if ($hasFooter)
                        <div
                            @class([
                                ...
                                'fi-sticky sticky bottom-0 border-t border-gray-200 py-5 dark:border-white/10 dark:bg-gray-900' => $stickyFooter,
