    ...
    {{
        $attributes->class([
            ...
            match ($aside) {
                ...
                false => 'rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10',
            },
        ])
    }}
>
    ...
    <div
        ...
        @class([
            ...
            'rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:col-span-2' => $aside,
