...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        ...(
            $outlined ?
                ...
                [
                    'shadow-sm' => ! $grouped,
                    'text-gray-950 hover:bg-gray-50 dark:bg-white/5 dark:text-white dark:hover:bg-white/10' => ($color === 'gray') || ($tag === 'label'),
    ...
    $badgeContainerClasses = 'fi-btn-badge-ctn absolute start-full top-0 z-[1] w-max -translate-x-1/2 -translate-y-1/2 rounded-md dark:bg-gray-900 rtl:translate-x-1/2';
