...
>
    ...
    @if (! \Filament\Support\is_slot_empty($slot))
        <div
            ...
            @endif
            @class([
                'fi-dropdown-panel absolute z-10 w-screen divide-y divide-gray-100 rounded-lg shadow-lg ring-1 ring-gray-950/5 transition dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10',
                match ($width) {
