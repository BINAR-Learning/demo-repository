                ...
                >
                    @foreach ($containers as $uuid => $item)
                        ...
                        <li
                            ...
                            class="fi-fo-repeater-item divide-y divide-gray-100 rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:divide-white/10 dark:bg-white/5 dark:ring-white/10"
                        ...
                        @if (! $loop->last)
                            @if ($isAddable && $addBetweenAction(['afterItem' => $uuid])->isVisible())
                                <li class="flex w-full justify-center">
                                    <div
                                        class="fi-fo-repeater-add-between-action-ctn rounded-lg dark:bg-gray-900"
                                    >
