...
<div
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-fo-wizard',
                'fi-contained rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10' => $isContained,
            ])
    }}
>
    <input
    ...
    <ol
        ...
        @class([
            ...
            'rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10' => ! $isContained,
        ])
        x-ref="header"
    >
