            ...
            >
                ...
                @foreach ($containers as $uuid => $item)
                    ...
                    <li
                        ...
                        class="fi-fo-builder-item rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10"
                    ...
                    @if (! $loop->last)
                        @if ($isAddable && $addBetweenAction(['afterItem' => $uuid])->isVisible())
                            <li class="relative -top-2 !mt-0 h-0">
                                ...
                                >
                                    <div
                                        class="fi-fo-builder-block-picker-ctn rounded-lg dark:bg-gray-900"
                                    >
